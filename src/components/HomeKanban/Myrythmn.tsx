...
export default function MyRythm() {
  return (
    <div>
      <div
...
>
  ...
  <div className="flex flex-col border border-mist bg-white shadow-sm rounded-2xl">
    <div className="flex w-full items-center px-4 h-12 pb-1">
      <div className="text-ay-h4 font-bold">Rhythms</div>
      <div className="grow" />
      <button
    ...
    <div className="mb-2">
      <div>
        {/**/}
        <div className="dashboards-activities-calendar-row h-[36px] group flex w-full items-center gap-2 px-4 py-1 transition-colors hover:cursor-pointer hover:bg-steam">
          <div className="flex w-full min-w-0 grow items-center">
            <div
              data-e2e="workspace-icon"
              className="workspace-icon flex shrink-0 items-center justify-center leading-[0] text-kimberly w-8 h-8 sm:w-6 sm:h-6 text-[20px] sm:text-[16px] rounded"
            >
              <svg
                width={16}
                height={16}
              ...
              >
                ...
                />
                <path
                  d="M13.9792 8.5C13.9925 8.66467 13.9999 8.83333 13.9999 9C14.0005 9.506 13.9368 10.01 13.8105 10.5"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M12.5957 5.14258C12.9215 5.52975 13.1968 5.95672 13.415 6.41324"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M12.5822 12.875C12.4755 13.0012 12.3626 13.1239 12.2435 13.243C11.886 13.6011 11.4846 13.9125 11.0488 14.1697"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M8.5 14.9793C8.33533 14.9927 8.16667 15 8 15C6.4087 15 4.88258 14.3679 3.75736 13.2426C2.63214 12.1174 2 10.5913 2 9C2 7.4087 2.63214 5.88258 3.75736 4.75736C4.88258 3.63214 6.4087 3 8 3H9.5"
                  stroke="currentColor"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="truncate text-ay-p2 font-medium text-dark">
              <span>princeaa</span>
            </div>
            <div className="ml-auto truncate rounded px-2 py-1 text-ay-c1 text-dark md:ml-2 bg-lipstick-800">
              09:00
            </div>
            <div className="ml-auto hidden items-center space-x-1 md:flex">
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-16T08:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              </span>
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-11T08:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              ...
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-12T08:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              ...
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-13T08:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              ...
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-14T08:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              ...
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-15T08:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
        ...
        <div className="dashboards-activities-calendar-row h-[36px] group flex w-full items-center gap-2 px-4 py-1 transition-colors hover:cursor-pointer hover:bg-steam">
          <div className="flex w-full min-w-0 grow items-center">
            ...
            <div className="ml-auto truncate rounded px-2 py-1 text-ay-c1 text-dark md:ml-2 bg-lipstick-800">
              Mar 15 &lsquo;24 15:00
            </div>
            <div className="ml-auto hidden items-center space-x-1 md:flex">
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-22T14:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark border-mist bg-mist"
                    style={{ opacity: 1 }}
                  />
                </button>
              </span>
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-02-16T14:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              ...
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-02-23T14:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              ...
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-01T14:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              ...
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-08T14:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
              ...
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-15T14:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark bg-lipstick"
                    style={{ opacity: 1 }}
                  />
                </button>
        ...
        <div className="dashboards-activities-calendar-row h-[36px] group flex w-full items-center gap-2 px-4 py-1 transition-colors hover:cursor-pointer hover:bg-steam">
          <div className="flex w-full min-w-0 grow items-center">
            <div
              data-e2e="workspace-icon"
              className="workspace-icon flex shrink-0 items-center justify-center leading-[0] text-azure w-8 h-8 sm:w-6 sm:h-6 text-[20px] sm:text-[16px] rounded"
            >
              <i
                className="ri-heart-pulse-fill text-lg leading-none"
                style={{ fontSize: "inherit !important" }}
              />
            </div>
            <div className="truncate text-ay-p2 font-medium text-dark">
            ...
            <div className="ml-auto truncate rounded px-2 py-1 text-ay-c1 text-dark md:ml-2 bg-lipstick-800">
              Mar 15 &lsquo;24 9:00
            </div>
            <div className="ml-auto hidden items-center space-x-1 md:flex">
              <span>
                <button className="w-full flex items-center" type="button">
                  <span
                    data-date="2024-03-18T08:00:00.000Z"
                    className="flex h-4 w-4 items-center justify-center rounded text-ay-c1 text-dark border-mist bg-mist"
                    style={{ opacity: 1 }}
                  />
                </button>
